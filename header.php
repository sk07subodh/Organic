...
<body>
    ...
    <!-- Navigation -->
    <nav id="siteNav" class="navbar-fixed-top nev" role="navigation">
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbar">
				...
				<?php if (isset($_SESSION['access_token']) || isset($_SESSION['fb_token']) || isset($_SESSION['name']) ): ?>
				...
				<!--After Login-->
					...
					<li class="dropdown">
						<a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false" >Hello <?= $_SESSION['user_id']; ?> &nbsp; <i class="fa fa-power-off"></i></a>
						<ul class="dropdown-menu" aria-labelledby="about-us">
							<li><a href="personal_info.php">My Profile</a></li>
							<li><a href="cart.php">My Cart</a></li>
							<li><a href="logout.php">LogOut</a></li>
				...
				<?php elseif (isset($_SESSION['name'])): ?>
                        <li class="dropdown">
						<a href="" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false" >Hello <?= $_SESSION['name'] ?>&nbsp; <i class="fa fa-power-off"></i></a>
						<ul class="dropdown-menu" aria-labelledby="about-us">
							<li><a href="personal_info.php">My Profile</a></li>
							<li><a href="cart.php">My Cart</a></li>
                            <li><a href="logout.php">LogOut</a></li>
				...
				<?php elseif (isset($_SESSION['f_name'])): ?>
                        <li class="dropdown">
