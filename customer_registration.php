...
include "db.php";
	...
	*/
	...
	$sql="INSERT INTO users(name,email,mobile,gender,password,user_activation_code,user_email_status,created,modified)VALUES('$name','$email','$mobile','$gender','$password','$user_activation_code','$user_email_status','".date("Y-m-d H:i:s")."','".date("Y-m-d H:i:s")."')";
