		...
		<h3 style="color:#59B210;">PERSONAL DETAILS</h3>
			...
			<div class="form-group">
			  <label class="control-label" for="email_id">Name <font color="red">*</font></label>
				<div class="input-group">
				  ...
				  <input id="firstname" name="firstname" class="form-control" placeholder="" type="text" required="" value="<?php echo $name?>">
				</div>
			</div>
			<!--<div class="form-group">
			...
			<div class="form-group">
			  <label class="control-label" for="state">E-Mail <font color="red">*</font></label>
				<div class="input-group">
				  <span class="input-group-addon"></span>
				  <input id="state" name="state" class="form-control" placeholder="" type="text" required=""value="<?php echo $email?>"> 
				</div>
			</div>				
