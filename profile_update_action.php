...
if(isset($_POST['submit'])) 
{
	...
	elseif (isset($_SESSION['user_id'])) {
		...
		$sqlSignup= "UPDATE  users SET name='$firstname',mobile='$mobile', dob='$dob', address='$address', city='$city', state='$state', pincode='$pincode', modified='".date("Y-m-d H:i:s")."' WHERE user_id='$user_id'";
		$sendData=mysqli_query($con, $sqlSignup);		
	}elseif (isset($_SESSION['farmer_id'])) {

		$sqlSignup= "UPDATE  farmers SET f_name='$firstname',mobile='$mobile',  WHERE farmer_id='$user_id'";
		$sendData=mysqli_query($con, $sqlSignup);		
	}
	else{
			echo '<script type="text/javascript">
